...
> **NOTA DE ESTADO (2026-09-05):** Este documento data de 2026-07-20 y describe la fase **R-6d** (cobertura técnica de demo). Ya no es la referencia vigente. Estado actual: R-0→R-6 desarrollo completado; frontpage, prueba real, reporte y portal HR desplegados en AWS (CloudFront `d3citl7gomy2ql.cloudfront.net`, 2026-09-05). Foco abierto: **R-7 validación comparativa con datos** y fases de producto M/G/Exp/T. Consultar el plan maestro `docs/plans/2026-09-04-aws-frontpage-deploy-master-plan.md` y el handoff actualizado `docs/plans/postulation-demo-original-games-new-agent-handoff.md`. El contenido histórico siguiente se conserva como trazabilidad de R-6d.
