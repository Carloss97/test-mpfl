...
export const ORIGINAL_GAME_FEATURE_DEFINITIONS = Object.freeze({
  ...
  'team.leadershipScore': Object.freeze({
    ...
    constructRelevance: 'Primary structured input for provisional leadership evidence (juicio social estructurado, no interacción grupal).',
    limitations: Object.freeze(['Not a group interaction or peer rating.', 'Requires validation before candidate comparison.', 'Reported as structured leadership judgment.']),
  }),
  'team.communicationScore': Object.freeze({
    ...
    constructRelevance: 'Primary structured input for provisional communication evidence (claridad/contexto/pasos, sin texto libre).',
  ...
  'team.adaptabilityScore': Object.freeze({
    ...
    constructRelevance: 'Descriptive context for adaptability evidence; not scored as a construct (T.4 #4/#12).',
    limitations: Object.freeze(['Scenario-based adaptation is not equivalent to longitudinal workplace flexibility.', 'Requires forms and validation.', 'Reported descriptively (score is not assigned).']),
  }),
  'team.decisionQualityScore': Object.freeze({
    ...
    constructRelevance: 'Structured evidence for decision-making readability, descriptive only (T.4 #11).',
    limitations: Object.freeze(['No normative cut score.', 'Does not establish real-world decision quality.', 'Kept as aggregated descriptive evidence, not a provisional score.']),
  }),
  'team.alignmentScore': Object.freeze({
    ...
    limitations: Object.freeze(['Contextual feature, not a standalone talent score.', 'Not a group interaction or peer rating.']),
  }),
