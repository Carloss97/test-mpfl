...
const AVAILABILITY_LABELS = Object.freeze({
  ...
  descriptive_only: { es: 'Lectura descriptiva', en: 'Descriptive reading' },
...
export function getPostulationCaveats(t, artifacts = null) {
  ...
  const labels = {
    synthetic_demo_fixture: t('Datos sintéticos de muestra; no corresponden a una persona real.', 'Synthetic sample data; does not correspond to a real person.'),
    ...
    original_games_r6d_mapping_available_in_talent_framework: t('Scores de prueba disponibles con límites explicados por constructo.', 'Assessment scores available with per-construct explained limits.'),
