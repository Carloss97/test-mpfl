...
export function usePostulationDemoCopy() {
  ...
  return {
    ...
    description: t(
      'Una experiencia gamificada donde cada actividad aporta métricas de desempeño y KRUMM prepara un reporte claro para revisión humana.',
      'A gamified experience where each activity contributes performance metrics and KRUMM prepares a clear report for human review.',
    ),
    timeEstimate: t('6-8 min', '6-8 min'),
    originalTimeEstimate: t('10–12 min', '10–12 min'),
    cta: t('Comenzar demo de postulación', 'Start application demo'),
