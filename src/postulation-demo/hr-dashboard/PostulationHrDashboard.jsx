    ...
    <div className="hr-dashboard">
      <header className="hr-dashboard__topbar">
        ...
        <nav aria-label={t('Navegación HR', 'HR navigation')}>
          <a className="hr-dashboard__nav-link hr-dashboard__nav-link--active" href="/postulaciones-demo/hr">{t('Evaluaciones', 'Evaluations')}</a>
          <a className="hr-dashboard__nav-link" href="/postulaciones-demo?battery=original">{t('Demo candidato', 'Candidate demo')}</a>
        </nav>
      ...
      <main className="hr-dashboard__main">
        <section className="hr-dashboard__hero" aria-labelledby="hr-dashboard-title">
          ...
          <div className="hr-dashboard__hero-actions">
            ...
            <a href="/postulaciones-demo?battery=original">{t('Volver a demo candidato', 'Back to candidate demo')}</a>
          </div>
        </section>
