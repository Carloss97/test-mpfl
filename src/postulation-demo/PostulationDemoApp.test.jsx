...
describe('PostulationDemoApp shell and flow', () => {
  ...
  it('detects the isolated postulation route (sin sufijo demo) without matching the technical app root', () => {
    expect(isPostulationDemoPath('/postulaciones')).toBe(true);
    expect(isPostulationDemoPath('/postulaciones?fixture=1')).toBe(true);
    expect(isPostulationDemoPath('/postulaciones/reporte')).toBe(true);
  ...
  it('opens directly into a synthetic fixture report when ?fixture=1 is present', () => {
    window.history.pushState({}, '', '/postulaciones?fixture=1');
  ...
  it('opens the original-games synthetic fixture when fixture and battery flags are combined', () => {
    window.history.pushState({}, '', '/postulaciones?fixture=1&battery=original');
    render(<PostulationDemoApp gameComponents={MOCK_GAMES} />);
