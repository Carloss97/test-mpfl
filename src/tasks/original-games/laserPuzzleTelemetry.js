...
export function buildLaserDemoLevels() {
  return [
    Object.freeze({
      id: 'laser-v2-1-orbita-quebrada',
      name: 'Órbita quebrada',
      nameEn: 'Broken orbit',
      difficulty: 'intermedia · cuatro movimientos',
      objective: 'Reconstruye una órbita de cuatro reflectores y activa todos los relés antes de alcanzar la antena.',
      objectiveEn: 'Rebuild a four-reflector orbit and light every relay before reaching the antenna.',
      coreChallenge: 'Planificar una cadena completa: cada reflector cambia el siguiente tramo y los cuatro son necesarios.',
      coreChallengeEn: 'Plan a complete chain: each reflector changes the next segment and all four are required.',
      cols: 8,
      rows: 8,
      par: 4,
      antennaCount: 1,
      ...
      solutionPlacements: Object.freeze([
        Object.freeze(['7,0', '0,2']),
        Object.freeze(['7,2', '3,2']),
        Object.freeze(['7,4', '3,5']),
        Object.freeze(['7,6', '1,5']),
      ]),
      cells: Object.freeze([
        Object.freeze({ x: 0, y: 0, type: 'ship', dir: 'down' }),
        Object.freeze({ x: 1, y: 7, type: 'antenna' }),
        Object.freeze({ x: 2, y: 2, type: 'relay' }),
        Object.freeze({ x: 3, y: 4, type: 'relay' }),
        Object.freeze({ x: 1, y: 6, type: 'relay' }),
        Object.freeze({ x: 7, y: 0, type: 'reflector_nw', movable: true }),
        Object.freeze({ x: 7, y: 2, type: 'reflector_nw', movable: true }),
        Object.freeze({ x: 7, y: 4, type: 'reflector_ne', movable: true }),
        Object.freeze({ x: 7, y: 6, type: 'reflector_ne', movable: true }),
        ...wallCells([
          { x: 2, y: 0 }, { x: 4, y: 0 }, { x: 5, y: 0 },
          { x: 4, y: 1 }, { x: 6, y: 1 }, { x: 5, y: 3 },
          { x: 1, y: 4 }, { x: 5, y: 5 }, { x: 3, y: 7 }, { x: 6, y: 7 },
        ]).map(Object.freeze),
      ]),
    }),
    Object.freeze({
      id: 'laser-v2-2-salto-cuantico',
      name: 'Salto cuántico',
      nameEn: 'Quantum leap',
      difficulty: 'planning · portal y cinco giros',
      objective: 'Entra al portal azul, recupera el haz al otro lado del mapa y encadena cinco reflectores hasta la antena.',
      objectiveEn: 'Enter the blue portal, recover the beam on the other side of the map, and chain five reflectors to the antenna.',
      coreChallenge: 'Razonar en dos espacios conectados: la dirección se conserva al atravesar el portal.',
      coreChallengeEn: 'Reason across two connected spaces: direction is preserved when crossing the portal.',
      cols: 8,
      rows: 7,
      par: 5,
      antennaCount: 1,
      ...
      solutionPlacements: Object.freeze([
        ...
        Object.freeze(['1,6', '6,3']),
        Object.freeze(['3,6', '3,3']),
        Object.freeze(['5,6', '3,1']),
        Object.freeze(['7,6', '7,1']),
      ]),
      cells: Object.freeze([
        Object.freeze({ x: 0, y: 3, type: 'ship', dir: 'right' }),
        Object.freeze({ x: 7, y: 5, type: 'antenna' }),
        Object.freeze({ x: 1, y: 3, type: 'relay' }),
        Object.freeze({ x: 6, y: 4, type: 'relay' }),
        Object.freeze({ x: 4, y: 3, type: 'relay' }),
        Object.freeze({ x: 4, y: 1, type: 'relay' }),
        Object.freeze({ x: 7, y: 4, type: 'relay' }),
        Object.freeze({ x: 2, y: 1, type: 'portal_blue', portalId: 'blue-a', targetPortalId: 'blue-b' }),
        Object.freeze({ x: 6, y: 5, type: 'portal_blue', portalId: 'blue-b', targetPortalId: 'blue-a' }),
        Object.freeze({ x: 0, y: 0, type: 'reflector_ne', movable: true }),
        Object.freeze({ x: 1, y: 6, type: 'reflector_nw', movable: true }),
        Object.freeze({ x: 3, y: 6, type: 'reflector_nw', movable: true }),
        Object.freeze({ x: 5, y: 6, type: 'reflector_ne', movable: true }),
        Object.freeze({ x: 7, y: 6, type: 'reflector_nw', movable: true }),
        ...wallCells([
          { x: 0, y: 1 }, { x: 0, y: 2 }, { x: 4, y: 2 }, { x: 5, y: 2 },
          { x: 0, y: 4 }, { x: 1, y: 4 }, { x: 2, y: 4 }, { x: 5, y: 5 },
        ]).map(Object.freeze),
      ]),
    }),
    Object.freeze({
      id: 'laser-v2-3-nexo-gemelo',
      name: 'Nexo gemelo',
      nameEn: 'Twin nexus',
      difficulty: 'advanced · portal, bifurcación y dos antenas',
      objective: 'Divide el haz: una rama debe atravesar el portal rojo y la otra bordear el campo de meteoritos.',
      objectiveEn: 'Split the beam: one branch must cross the red portal and the other skirt the meteor field.',
      coreChallenge: 'Coordinar seis reflectores y dos rutas simultáneas sin perder ninguno de los seis relés.',
      coreChallengeEn: 'Coordinate six reflectors and two simultaneous routes without losing any of the six relays.',
      cols: 8,
      rows: 8,
      par: 6,
      antennaCount: 2,
      ...
      timeLimitMs: 160_000,
      solutionPlacements: Object.freeze([
        Object.freeze(['0,0', '7,5']),
        Object.freeze(['1,0', '5,5']),
        Object.freeze(['2,0', '5,1']),
        Object.freeze(['4,7', '3,6']),
        Object.freeze(['5,7', '6,6']),
        Object.freeze(['6,7', '6,4']),
      ]),
      cells: Object.freeze([
        Object.freeze({ x: 0, y: 3, type: 'ship', dir: 'right' }),
        Object.freeze({ x: 3, y: 3, type: 'bifurcator' }),
        Object.freeze({ x: 7, y: 1, type: 'antenna' }),
        Object.freeze({ x: 7, y: 4, type: 'antenna' }),
        Object.freeze({ x: 3, y: 1, type: 'portal_red', portalId: 'red-a', targetPortalId: 'red-b' }),
        Object.freeze({ x: 7, y: 7, type: 'portal_red', portalId: 'red-b', targetPortalId: 'red-a' }),
        Object.freeze({ x: 7, y: 6, type: 'relay' }),
        Object.freeze({ x: 6, y: 5, type: 'relay' }),
        Object.freeze({ x: 5, y: 3, type: 'relay' }),
        Object.freeze({ x: 3, y: 4, type: 'relay' }),
        Object.freeze({ x: 4, y: 6, type: 'relay' }),
        Object.freeze({ x: 5, y: 6, type: 'relay' }),
        Object.freeze({ x: 0, y: 0, type: 'reflector_nw', movable: true }),
        Object.freeze({ x: 1, y: 0, type: 'reflector_nw', movable: true }),
        Object.freeze({ x: 2, y: 0, type: 'reflector_ne', movable: true }),
        Object.freeze({ x: 4, y: 7, type: 'reflector_nw', movable: true }),
        Object.freeze({ x: 5, y: 7, type: 'reflector_ne', movable: true }),
        Object.freeze({ x: 6, y: 7, type: 'reflector_ne', movable: true }),
        ...wallCells([
          { x: 7, y: 0 }, { x: 0, y: 1 }, { x: 1, y: 1 }, { x: 0, y: 5 },
          { x: 1, y: 5 }, { x: 2, y: 5 }, { x: 0, y: 7 }, { x: 1, y: 7 },
        ]).map(Object.freeze),
      ]),
    }),
  ];
