...
export function buildLaserDemoLevels() {
  return [
    Object.freeze({
      id: 'laser-final-1-calibracion-orbital',
      name: 'Calibración orbital',
      difficulty: 'intro · una antena',
      objective: 'Reconectar una antena aislada usando una cadena mínima de reflectores.',
      coreChallenge: 'Aprender la regla de reflexión sin presión de múltiples objetivos.',
      cols: 8,
      rows: 8,
      par: 4,
      antennaCount: 1,
