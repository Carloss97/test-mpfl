...
export function buildPassengerRouteDemoLevels() {
  return [
    freezeLevel({
      id: 'passenger-v2-1-barrio-luz',
      name: 'Barrio Luz: entrega guiada',
      nameEn: 'Luz District: guided delivery',
      difficulty: 'intro · reserva amplia',
      objective: 'Completa una entrega guiada y llega con una reserva segura de energía.',
      objectiveEn: 'Complete a guided delivery and arrive with a safe energy reserve.',
      coreChallenge: 'Aprender costos horizontales y verticales sin depender de recargas.',
      coreChallengeEn: 'Learn horizontal and vertical costs without depending on recharges.',
      cols: 7,
      rows: 6,
      routeBudget: 14,
      timeLimitMs: 75_000,
    ...
    freezeLevel({
      id: 'passenger-v2-2-mercado-puentes',
      name: 'Mercado de los Puentes',
      nameEn: 'Bridges Market',
      difficulty: 'planning · dos entregas, recarga opcional',
      objective: 'Ordena dos entregas conectando ambos barrios sin depender de la estación de apoyo.',
      objectiveEn: 'Sequence two deliveries linking both districts without depending on the support station.',
      coreChallenge: 'Elegir el orden eficiente y conservar al menos cuatro unidades de reserva en la ruta óptima.',
      coreChallengeEn: 'Choose the efficient order and keep at least four reserve units on the optimal route.',
      cols: 8,
      rows: 7,
      routeBudget: 22,
      timeLimitMs: 105_000,
      start: { x: 1, y: 5 },
      walls: ['0,0', '3,0', '4,0', '7,0', '0,3', '3,3', '7,3', '0,6', '3,6', '4,6', '7,6'],
      stations: [{ x: 4, y: 4 }],
      passengers: [
        {
          id: 'A',
    ...
    freezeLevel({
      id: 'passenger-v2-3-terminal-norte',
      name: 'Operación Terminal Norte',
      nameEn: 'North Terminal Operation',
      difficulty: 'advanced · una recarga estratégica',
      objective: 'Encadena dos entregas y utiliza una única recarga estratégica en el corredor norte.',
      objectiveEn: 'Chain two deliveries and use a single strategic recharge in the north corridor.',
      coreChallenge: 'Planificar el orden completo antes de salir y terminar con reserva, no al límite.',
      coreChallengeEn: 'Plan the full order before leaving and finish with reserve, not at the limit.',
      cols: 9,
      rows: 7,
      routeBudget: 16,
      timeLimitMs: 120_000,
      start: { x: 1, y: 5 },
      walls: ['0,0', '3,0', '5,0', '8,0', '0,2', '8,2', '0,4', '3,4', '5,4', '8,4', '0,6', '4,6', '8,6'],
      stations: [{ x: 7, y: 4 }],
      passengers: [
        {
          id: 'A',
  ...
  while (queue.length > 0) {
    ...
    if (current.deliveredMask === deliveredGoal && current.onboard < 0) {
      return {
        ...
        remainingBudget: current.budget,
      };
    }
